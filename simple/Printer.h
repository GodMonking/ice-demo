...
public:
    ...
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &Demo::PrinterPrx::_iceI_printString, s, context);
    }
...
class Printer;
/// \cond INTERNAL
void _readProxy(::Ice::InputStream*, ::IceInternal::ProxyHandle< Printer>&);
::IceProxy::Ice::Object* upCast(Printer*);
/// \endcond
